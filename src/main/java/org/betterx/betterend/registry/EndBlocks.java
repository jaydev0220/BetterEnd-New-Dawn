...
public class EndBlocks {
    ...
    private static void registerBlocks() {
        ...
        MOSSY_GLOWSHROOM = new EndWoodenComplexMaterial( "mossy_glowshroom", MapColor.COLOR_GRAY, MapColor.WOOD, Blocks.WOOL.gray() ).init();
        ...
        PYTHADENDRON = new EndWoodenComplexMaterial( "pythadendron", MapColor.COLOR_MAGENTA, MapColor.COLOR_PURPLE, Blocks.WOOL.black() ).init();
        ...
        DRAGON_TREE = new EndWoodenComplexMaterial( "dragon_tree", MapColor.COLOR_BLACK, MapColor.COLOR_MAGENTA , Blocks.WOOL.black() ).init();
        ...
        TENANEA = new EndWoodenComplexMaterial( "tenanea", MapColor.COLOR_BROWN, MapColor.COLOR_PINK, Blocks.WOOL.pink() ).init();
        ...
        HELIX_TREE = new EndWoodenComplexMaterial( "helix_tree", MapColor.COLOR_GRAY, MapColor.COLOR_ORANGE, Blocks.WOOL.gray() ).init();
        ...
        UMBRELLA_TREE = new EndWoodenComplexMaterial( "umbrella_tree", MapColor.COLOR_BLUE, MapColor.COLOR_GREEN, Blocks.WOOL.magenta() ).init();
        ...
        JELLYSHROOM = new EndWoodenComplexMaterial( "jellyshroom", MapColor.COLOR_PURPLE, MapColor.COLOR_LIGHT_BLUE, Blocks.WOOL.purple() ).init();
        ...
        LUCERNIA = new EndWoodenComplexMaterial( "lucernia", MapColor.COLOR_ORANGE, MapColor.COLOR_ORANGE, Blocks.WOOL.white() ).init();
